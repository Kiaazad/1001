init: # Ingredient
    ...
    default big_quartz = item(
        _("Big quartz crystal"),
        _("Too pretty for it's worth."),
        "big_quartz",
        200,
        )
    default marble = item(
        _("Marble"),
        _("White pretty stone."),
        "marble",
        10,
        )
...
init: # rugs
    default sheep_skin = item(
        _("Sheep skin"),
        _("A cured sheep skin."),
        "sheep_skin",
        1850,
        )
    default red_rug = item(
        _("Red rug"),
        _("A pretty rug."),
        "red_rug",
        3450,
        )
    default blue_rug = item(
        _("Blue rug"),
        _("A classic design."),
        "blue_rug",
        4100,
        )
    default blue_red_rug = item(
        _("Blue and red rug"),
        _("Looks pretty ugly."),
        "blue_red_rug",
        2900,
        )
    default another_red_rug = item(
        _("Red rug"),
        _("Looks like another red rug."),
        "another_red_rug",
        3900,
        )